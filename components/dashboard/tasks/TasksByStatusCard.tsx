// components/dashboard/tasks/TasksByStatusCard.tsx
"use client";
...
export default function TasksByStatusCard() {
  const rows: Row[] = [
    { label: "To Do",        value: 320, color: "#60A5FA" }, // blue-400
    { label: "In Progress",  value: 140, color: "#F59E0B" }, // amber-500
    { label: "Review",       value: 90,  color: "#8B5CF6" }, // violet-500
    { label: "Done",         value: 820, color: "#10B981" }, // emerald-500
  ];
  ...
  return (
    <div className="rounded-3xl bg-white p-5 shadow-[0_8px_30px_rgba(2,6,23,0.06)] ring-1 ring-slate-200/60">
      ...
      <div className="mb-4 flex items-center justify-between">
        <h3 className="text-[18px] font-semibold text-slate-900">Tasks by Status</h3>
            ...
            <div key={r.label} className="group">
              <div className="mb-1 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="tabular-nums text-[12px] text-slate-500">{r.value.toLocaleString()}</span>
                </div>
              </div>
              ...
              <div
                ...
                aria-label={`${r.label} ${r.value} tasks, ${pct.toFixed(0)} percent`}
                role="meter"
                aria-valuemin={0}
                aria-valuemax={100}
              ...
              >
                ...
                <div
                  ...
                  style={{
                    width: `${pct}%`,
                    background: gradient,
                    boxShadow: "0 4px 12px rgba(2,6,23,0.08), inset 0 1px 0 rgba(255,255,255,.5)",
                  }}
                />
              </div>
            </div>
          ...
          {rows.map((r) => {
            ...
            return (
              <div
                key={r.label}
                className="h-full"
                style={{ width: `${pct}%`, backgroundColor: r.color, opacity: 0.7 }}
